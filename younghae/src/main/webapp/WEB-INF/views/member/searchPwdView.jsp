					...
					<div class="panel-body p-3">
						<form action="login_script.php" method="POST">
							...
							<div class="form-group py-1 pb-2">
								<div>
									이메일 인증번호확인 *
									<button type="button" style="float: right; border: 0;">인증번호
										전송</button>
								</div>
								<!-- <div>이메일 인증번호확인 * <button type="button" style="float: right; border: 0; ">인증번호 재전송</button></div>  -->
								<div class="input-field">
									<input type="text" placeholder="인증번호를 입력해주세요" required>
									<button type="button"
										style="float: right; border: 0; width: 46px;">확인</button>
								</div>
							</div>
