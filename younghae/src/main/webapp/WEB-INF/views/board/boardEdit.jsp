            ...
            <div class="row">
                <div class="col-lg-4 col-md-5">
                    ...
                    <div class="col-lg-8 col-md-7 order-md-1 order-1">
                        ...
                        <br>
                        <textarea class="container" id="boardContent" style="border: 2px solid #24E082; border-radius: 3%;">
                    ...
                    <div class="col-lg-6">
                        <button class="btn bn_btn_search2" id="boardWriteBtn" type="button">SUBMIT</button>
