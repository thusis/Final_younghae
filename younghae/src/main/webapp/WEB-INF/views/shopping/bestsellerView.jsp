    ...
    <section class="product spad" style="margin-top: -5%;">
        <div class="container" >
            ...
            <div class="row">
               ...
               <button class="col-lg-2" style="color: #FD9F28; font-weight: bold; font-size: 25px; background-color: white; border: none;" onclick="location.href='${contextPath}/bestsellerView.sh'">베스트셀러</button>
				...
				$.ajax({
					...
					success:(data)=>{
				        ...
				        document.getElementById('beforeBtn').addEventListener('click',function(){
				        	location.href = '${contextPath}/bestsellerView.sh';
				        });
