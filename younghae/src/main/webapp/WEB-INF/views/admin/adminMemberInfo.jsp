        ...
        <div class="row">
            <div class="offset-md-2 col-lg-5 col-md-7 offset-lg-4 offset-md-3 ">
                <div class="panel" style="border: 1px solid rgb(122, 122, 122);">
                    ...
                    <!-- 일반회원 -->
                    <c:if test="${ Member.userCNumber eq '1'}">
                            ...
                            <div class="panel-body p-3">
                                <div class="form-group py-2">
                                    ...
                                    <div class="input-field" id="myId2">
                                        <input type="text" id="myId" name="userId" value="${Member.userId }" required readonly>
                                    </div>
                                </div>
                                <div class="form-group py-2">
                                    <div>이름*</div>
                                    <div class="input-field" id="myName2">
                                        <input type="text" id="myName" name="userName" value="${ Member.userName }" readonly>
                                    </div>
                                </div>
                                <div class="form-group py-2">
                                    <div>닉네임*</div>
                                    <div class="input-field" id="myNickName2" >
                                        <input type="text" id="myNickName" name="userNickname" value="${ Member.userNickname }" required>
                                    </div>
                                </div>
                                <div class="form-group py-2">
                                    <div>이메일*</div>
                                    <div class="input-field" id="myEmail2">
                                        <input type="email" id="myEmail" style="width: 100%; border: 0;" name="email" value="${Member.email }" readonly>
                                    </div>
                                </div>
                                <div class="form-group py-2">
                                    <div>성별*</div>
                                    <c:if test="${ Member.gender eq 'M'}">
	                                    <div>
	                                        <input type="radio" name="gender" value="M" required="required" checked readonly>
	                                        <a style="margin-right: 80px;">남</a>
	                                        <input type="radio" name="gender" value="F" required="required" readonly>
	                                        <a style="margin-right: 80px;">여</a>
	                                        <input type="radio" name="gender" value="N" required="required" readonly>
	                                        <a>알리고싶지않음</a>
	                                    </div>
                                    </c:if>
                                ...
                                <div class="form-group py-2">
                                    ...
                                    <div class="input-field">
                                        <input type="text" name="birth" value="${Member.userBirth }" required>
                                    </div>
                                </div>
                                <div class="form-group py-2">
                                    <div>전화번호*</div>
                                    <div class="input-field">
                                        <input type="text" id="myPhone" name="userPhone" value="${Member.userPhone }" required>
                                    </div>
                                </div>
                                <div class="form-group py-2">
                                    <div>
                                ...
                                <div class="form-group py-2">
                                    <div>내 추천인코드</div>
                                    <div class="input-field">
                                        <input type="text" id="otherRecommand" name="userRecommend" value="${ Member.userRecommend }" readonly>
                                    </div>
                                </div>
                    ...
                    <!-- 전문가회원 -->
                    <c:if test="${ Member.userCNumber eq '2'}">
                        <form action="${ contextPath }/myInfoEdit.me" method="POST" id='insertForm'>
                            ...
                            <div class="panel-body p-3">
                                ...
                                <div class="form-group py-2">
                                    <div>전화번호</div>
                                    <div class="input-field">
                                        <input type="text" id="myPhone" name="userPhone" value="${Member.userPhone }">
                                    </div>
                                </div>
                                <c:if test="${Member.userCNumber eq '1' }">
	                                <div class="form-group py-2">
