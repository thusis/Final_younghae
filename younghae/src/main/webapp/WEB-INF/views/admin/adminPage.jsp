            ...
            <div class="row">
                <div class="col-lg-2" style="margin-left:-100px; margin-top:50px;">
                    <div class="hero__categories">
                        <ul>
                            ...
                            <li><a href="#" onclick="location.href='${contextPath}/adminReviewList.su'">리뷰관리</a></li>
                ...
                <div class="col-lg-10">
                    ...
                    <div style="text-align:center; margin-top:100px;">
                        ...
                        </svg><div style="margin-right:100px; margin-left:30px;display:inline-block">주문<br>1</div>
                <svg xmlns=" http://www.w3.org/2000/svg" width="100" height="100" fill="currentColor" class="bi bi-calculator" viewBox="0 0 16 16">
                            ...
                            </svg><div style="margin-right:100px; margin-left:30px;display:inline-block">결제<br><a>1</a></div>
