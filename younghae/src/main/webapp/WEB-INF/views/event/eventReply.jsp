...
<body>
	...
	<br>
	<br>
	<h4 id="eventTitle">✨✍ 영해의 댓글 이벤트 ✍✨</h4>

	<hr width="80%" style="border: 2px solid #24E082;" noshade />
	<br>
	<br>
	<div class="attendance">
		<img src="resources/img/event/reply.png"
			style="width: 800px; height: 800px;">
	</div>

	<br>
	<br>
	<div id="eventReplyBtn">
		<a href="#" class="btn-3d red">댓글 쓰러가기</a> <a href="#"
			class="btn-3d red">보상받기</a>
	</div>
	<br>
	<br>
