        ...
        <div class="col-lg-12 d-flex justify-content-center">
            <div class="panel col-lg-6 " style="border: 1px solid rgb(122, 122, 122);">
                <div class="panel-heading">
                    <a href="#"><img src="resources/img/logo.svg" alt="" style="height: 60px; width: 80px;"></a> <span style="font-size: 20px; margin-left: 5px; vertical-align: middle; font-weight: bold;">나의
                        프로필 설정 </span>
                </div>
                    ...
                    <div class="tab-pane active" id="tabs-1" role="tabpanel">
                        <form action="login_script.php" method="POST">
                            <div class="panel-body p-3">
                                ...
                                <button class="btn btn-primary btn-block mt-3 " style="background-color: rgb(0, 179, 0); border-color: rgb(0, 179, 0);">프로필등록 및 수정</button>
                            </div>
                        </form>
                    </div>
                </div>
